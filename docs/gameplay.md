...
**Deck open-side skate-off** (`####(((=====` and mirrors): grounded leave is free air (`air_launch` = that `#`), never a wipeout. Descending onto the abutting pipe/ramp ride face while traveling with the slope **Mounts**; foreign-lip Reject is into-face only.
